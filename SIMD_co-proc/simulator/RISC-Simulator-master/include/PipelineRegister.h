...
public:
	...
	Register<unsigned long long int> VA;
	Register<unsigned long long int> VB;
	Register<unsigned long long int> Voperand2;
	Register<unsigned int> operand2;
	Register<unsigned int> aluResult;
	Register<unsigned long long int> ValuResult;
